    ...
    <View className="bg-[#FFFFFF] flex-1 rounded-t-2xl pt-[60px] px-[38px] h-full justify-between items-center">
        ...
        <View className="w-full items-center mb-5">
            ...
            <View className="w-full items-center justify-center mt-10">
                ...
                : skip && <Pressable onPress={skipNextScreen}><Text style={{fontFamily:'geometria-regular'}} className="text-xs leading-[14px] text-[#4BAAC5] opacity-50">Изменить позже</Text></Pressable>
                }
            </View>}
        </View>
    </View>
