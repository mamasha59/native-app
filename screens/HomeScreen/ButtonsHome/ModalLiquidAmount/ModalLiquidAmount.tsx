          ...
          <View className={`${focus && 'opacity-30'} flex-1 justify-center`}>
                <Slider
                    ...
                    renderAboveThumbComponent={() =>
                        <Text style={{fontFamily:'geometria-regular'}} className="text-[12px] justify-center items-center leading-3 text-[#101010] opacity-70">{Math.floor(liquidValue)+ ' мл'}</Text>}
