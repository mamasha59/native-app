...
const NoticeAccessHomeScreen = () => {
  return (
    <MainLayout title="Уведомления и доступ">
        ...
        <Text style={{fontFamily:'geometria-regular'}} className="text-[#4BAAC5] text-sm leading-4 mb-4 mt-3">Настройки уведомлений</Text>
        ...
        <Text style={{fontFamily:'geometria-regular'}} className="text-[#4BAAC5] text-sm leading-4 mb-4 mt-8">Настройки доступа</Text>
        {/* настройки доступа */}
