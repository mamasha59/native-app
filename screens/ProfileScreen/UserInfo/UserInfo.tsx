...
const UserInfo = () => {
  ...
  return (
    ...
    <View className="border border-[#4babc557] rounded-xl p-[15px] max-w-[145px] w-full">
      <Text className="text-main-blue text-lg leading-[21px] font-bold mb-[10px]">{user.sex}</Text>
      <Text className="text-[#77787B] text-xs leading-[14px]">пол</Text>
    </View>
    <View className="border border-[#4babc557] rounded-xl p-[15px] max-w-[145px] w-full">
      <Text className="text-main-blue text-lg leading-[21px] font-bold mb-[10px]">{user.age}</Text>
    ...
    <View className="border border-[#4babc557] rounded-xl p-[15px] max-w-[300px] w-full">
      <Text className="text-main-blue text-lg leading-[21px] font-bold mb-[10px]">{user.volume}</Text>
      <Text className="text-[#77787B] text-xs leading-[14px]">объем мочевого пузыря</Text>
    </View>
    <View className="border border-[#4babc557] rounded-xl p-[15px] max-w-[145px] w-full">
      <Text className="text-main-blue text-lg leading-[21px] font-bold mb-[10px]">{user.catetorType}</Text>
      <Text className="text-[#77787B] text-xs leading-[14px]">тип катетера</Text>
    </View>
    <View className="border border-[#4babc557] rounded-xl p-[15px] max-w-[145px] w-full">
      <Text className="text-main-blue text-lg leading-[21px] font-bold mb-[10px]">{user.catetorSize}</Text>
